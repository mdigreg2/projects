...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=statenIslandTerrainmap&box=-74.073577,40.641854,-74.168287,40.569989
...
-----------
  ...
  * statenIslandTerrainmap Height Map (ASTER 30m).png
  ...
  * statenIslandTerrainmap Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * statenIslandTerrainmap Height Map (SRTM3 v4.1).png
  ...
  * statenIslandTerrainmap Height Map (SRTM30 Plus).png
  ...
  * statenIslandTerrainmap Height Map (USGS NED 10m).png
